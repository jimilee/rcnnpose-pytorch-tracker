...
class BYOL(nn.Module):
    def __init__(
        ...
        self.forward(torch.randn(2, 3, 128, 256), torch.randn(2, 3, 128, 256))
...
if __name__ == '__main__':
    btwins = BYOL(hidden_layer="avgpool")
    btwins.load_state_dict(torch.load('E:/_workspace/rcnnpose-pytorch-tracker/simsiam/ckpt/table3_byol.pt'))
    btwins.online_encoder # 256
    print(btwins.online_encoder(torch.randn(2, 3, 256, 128)))